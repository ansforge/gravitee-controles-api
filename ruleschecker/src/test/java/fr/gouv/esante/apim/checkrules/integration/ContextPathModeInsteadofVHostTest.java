...
@SpringBootTest(
        classes = {ContextPathModeInsteadofVHostTest.class, CheckRulesService.class,
...
@ActiveProfiles({"test"})
@Slf4j
class ContextPathModeInsteadofVHostTest {
    ...
    void testContextPathModeInsteadofVHost() throws Exception {
        String expectedMessage = String.format(
                "Erreur dans la configuration de sous-domaine d'accès à cette API :%sCette API n'est pas configurée en mode Virtual Host",
